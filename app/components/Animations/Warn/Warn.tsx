...
const Warn = ({ style }: { style?: CSSProperties }) => {
    const message = ["This website is under active construction.", "What you see here now may not stay!"];
    ...
    return <div className={ styles.container } style={{ ...style }}>
        ...
        <div className={ styles.warningMessage }>
            { message.map((part, index) => <Typing key={ index } text={ part } elementId={ `warning_part_${ index }` } style={{ letterSpacing: 1 }} /> )}
        </div>
    </div>
}
